...
{
    internal class DataMahasiswa103022300046
    {
        ...
        {
            String filePath = @"D:\praktikum\KPL\tpmodul_kelompok_3\tp7_1_103022300046.json" ;
            if (File.Exists(filePath))
            {
                ...
                DataMahasiswa103022300046 data = JsonSerializer.Deserialize<DataMahasiswa103022300046>(json, options);
